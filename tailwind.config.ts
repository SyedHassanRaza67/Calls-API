    ...
    extend: {
      ...
      keyframes: {
        ...
        "particle-2": {
          ...
          "50%": { transform: "translateY(-80px) translateX(-30px)", opacity: "0.8" },
      ...
      animation: {
        ...
        "pulse-glow-delayed": "pulse-glow-delayed 4s ease-in-out infinite 1s",
        "particle-1": "particle-1 15s ease-in-out infinite",
        "particle-2": "particle-2 18s ease-in-out infinite 3s",
        "particle-3": "particle-3 20s ease-in-out infinite 6s",
      },
    },
  },
